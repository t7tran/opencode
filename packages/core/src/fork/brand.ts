...
/**
 * Rebrand every string value of a flat translation dictionary, leaving keys and
 * non-string values untouched. Returns the input unchanged (same reference)
 * when nothing matched, so warm dictionaries are not needlessly copied.
 */
